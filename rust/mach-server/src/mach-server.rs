...
fn get_histogram(reader: MachReader, min_ts: u64, max_ts: u64) -> Vec<(u64, u64)> {
...
fn get_mach_cpu(reader: MachReader, min_ts: u64, _: u64) -> Vec<((u64, u64), u64)> {
    ...
    while let Some(entry) = iter.next_entry() {
        ...
        let record: Record = bincode::deserialize_from(&entry.data[..]).unwrap();
...
fn get_mach_sched(reader: MachReader, min_ts: u64, max_ts: u64) -> Vec<((u64, [u8; 16]), u64)> {
